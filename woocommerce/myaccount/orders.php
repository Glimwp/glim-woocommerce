...
add_action( 'wp_enqueue_scripts', function() {
	$styles = '';
	$styles .= glimfse( 'blocks' )->get( 'core/table' )::get_instance()->styles();
	
	wp_add_inline_style( 'global-styles', glimfse( 'styles' )::compress( $styles ) );
} );

glimfse( 'styles' )->Utilities->load( [ 'py-1', 'border', 'd-flex', 'ms-auto' ] );

do_action( 'woocommerce_before_account_orders', $has_orders ); ?>

<?php if ( $has_orders ) : ?>
<div class="wp-block-table card">
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders table table-bordered table-hover border">
		<thead>
			<tr>
