 ...
 * @subpackage GLIM\EXT\WOO\Autoloader
 */
...
class Autoloader {
	 ...
	 * @since 	1.0.0
	 */
	public function __construct( $namespace = 'GLIM\EXT\WOO', $root = __DIR__ ) { 
