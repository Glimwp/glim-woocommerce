"use strict";
(globalThis["webpackChunkGLIM_woocommerce"] = globalThis["webpackChunkGLIM_woocommerce"] || []).push([["vendors-node_modules_react-hook-form_dist_index_esm_js-node_modules_react-use_esm_factory_cre-4f5c83"],{
...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, shouldUnregister = true, criteriaMode, } = {}) {
    ...
    const removeFieldEventListener = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((field, forceDelete) => findRemovedFieldAndRemoveListener(fieldsRef, handleChangeRef.current, field, shallowFieldsStateRef, shouldUnregister, forceDelete), [shouldUnregister]);
...
const useFieldArray = ({ control, name, keyName = 'id', }) => {
    ...
    const getFieldArrayValue = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => get(fieldArrayValuesRef.current, name, []), []);
    ...
    return {
        ...
        append: (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(append, [name, fields]),
...
const Controller = (_a) => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => () => unregister(name), [unregister, name]);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        if (true) {
...
var createBreakpoint = function (breakpoints) {
    ...
    return function () {
        var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(_misc_util__WEBPACK_IMPORTED_MODULE_1__.isBrowser ? window.innerWidth : 0), screen = _a[0], setScreen = _a[1];
        (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
            var setSideScreen = function () {
                setScreen(window.innerWidth);
            };
            setSideScreen();
            (0,_misc_util__WEBPACK_IMPORTED_MODULE_1__.on)(window, 'resize', setSideScreen);
            return function () {
                (0,_misc_util__WEBPACK_IMPORTED_MODULE_1__.off)(window, 'resize', setSideScreen);
            };
        });
        var sortedBreakpoints = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () { return Object.entries(breakpoints).sort(function (a, b) { return (a[1] >= b[1] ? 1 : -1); }); }, [breakpoints]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createBreakpoint);
...
//# sourceMappingURL=vendors-node_modules_react-hook-form_dist_index_esm_js-node_modules_react-use_esm_factory_cre-4f5c83.js.map